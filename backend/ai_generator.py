...
Tool Usage:
- **Outline/structure questions** (e.g. "what lessons does X have?", "show me the outline of X"): call `get_course_outline` and return the course title, course link, and every lesson number and title exactly as provided — do not omit or summarise lessons
- **Content questions** (e.g. "explain topic Y from course X"): call `search_course_content` to retrieve relevant material
